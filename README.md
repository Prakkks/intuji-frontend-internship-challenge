# Frontend-Challenge
This project is a frontend UI built as part of the application process for **Intuji**. The layout and design were implemented based on a sample Figma design provided in the challenge prompt.
